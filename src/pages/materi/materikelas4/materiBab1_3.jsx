      ...
      <div className="materi-container">
        ...
        <div className="content-wrapper">
          <div className="video-container">
            <iframe
              src={`https://www.youtube.com/embed/CF-e7OCDrig?si=wPb1wQ9gobecHrXl&amp;start=15&mute=${isMuted ? 1 : 0}`}
              title="Komposisi Bilangan Cacah"
          ...
          <p className="materi-description">
            Mari belajar konsep dasar penjumlahan dengan cara yang menyenangkan!
            Kamu akan diajak menghitung harga belanjaan, tabungan harian, dan
            jumlah barang dengan contoh nyata.
          </p>
          ...
          <div className="ringkasan-section">
            ...
            <div className="konsep-pengurangan">
              ...
              <p className="konsep-content">
                Penjumlahan adalah proses menggabungkan dua atau lebih angka
                untuk mendapatkan jumlah total. Disini kita belajar bagaimana
                penjumlahan bilangan cacah sampai 10.000.
              </p>
              <div className="example">
                <p className="konsep-content">
                  Contoh dalam kehidupan sehari-hari:
                  <br />
                  • Kamu punya Rp300 dan diberi Rp700, total uangmu menjadi: 300
                  + 700 = Rp1.000
                  <br />• Lani menabung: Senin Rp200, Selasa Rp300, Rabu Rp400 →
                  total: Rp900
                </p>
              </div>
            </div>
