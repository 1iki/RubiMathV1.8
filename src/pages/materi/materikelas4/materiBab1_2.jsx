      ...
      <div className="materi-container">
        ...
        <div className="content-wrapper">
          <div className="video-container">
            <iframe
              src={`https://www.youtube.com/embed/jEhU9O3NCLw?si=FOQwZBO4wPmK2KG2${isMuted ? 1 : 0}`}
              title="Membandingkan dan Mengurutkan Bilangan Cacah"
          ...
          <p className="materi-description">
            Yuk, kita bandingkan bilangan mana yang lebih besar atau lebih
            kecil, lalu susun angka dari yang terkecil hingga terbesar atau
            sebaliknya. Seru, kan?
          </p>
          ...
          <div className="ringkasan-section">
            ...
            <div className="konsep-pengurangan">
              ...
              <p className="konsep-content">
                Kita bisa membandingkan dua bilangan untuk melihat mana yang
                lebih besar atau lebih kecil, dan mengurutkannya dari kecil ke
              ...
              <div className="example">
                <p className="konsep-content">
                  ...
                  <br />
                  • 7.846 lebih besar dari 7.416 karena ratusannya 8 lebih besar
                  dari 4
                  <br />• Urutan dari kecil ke besar: 2.987, 4.213, 5.123
                </p>
              </div>
            </div>
          </div>
