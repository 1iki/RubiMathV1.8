      ...
      <div className="materi-container">
        ...
        <div className="content-wrapper">
          <div className="video-container">
            <iframe
              src={`https://www.youtube.com/embed/exTDMKRUO9s?autoplay=1&mute=${isMuted ? 1 : 0}`}
              title="Cara Membaca dan Menulis Bilangan Cacah"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
          </div>

          <h1 className="materi-title">Cara Membaca dan Menulis Bilangan Cacah</h1>

          <p className="materi-description">
            Pernah lihat label harga di minimarket? Nah, itu adalah bilangan
            cacah! Di sini kamu akan belajar bagaimana membaca angka-angka besar
            seperti 6.786 dengan mudah.
          </p>
          ...
          <div className="ringkasan-section">
            ...
            <div className="konsep-pengurangan">
              ...
              <p className="konsep-content">
                Bilangan cacah adalah angka-angka seperti 0, 1, 2, 3, dan
                seterusnya, tanpa bilangan negatif. Kita bisa membaca dan
                menulis bilangan hingga 10.000 dengan melihat posisi digit:
                satuan, puluhan, ratusan, dan ribuan.              </p>
              <div className="example">
                <p className="konsep-content">
                  Contoh dalam kehidupan sehari-hari:
                  <br />
                  • Angka 7.508 dibaca: Tujuh Ribu Lima Ratus Delapan.
                  <br />• Kata “Delapan Ribu Empat Ratus Lima Puluh” ditulis
                  sebagai: 8.450                </p>
              </div>
            </div>
          </div>
