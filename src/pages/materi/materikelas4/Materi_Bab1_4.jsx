...
const MateriSubBab4 = () => {
  ...
  const handleLatihan = () => {
    ...
    window.location.href = '/game/subtraction';
  };
      ...
      <div className="materi-container">
        ...
        <div className="content-wrapper">
          <div className="video-container">
            <iframe
              src={`https://www.youtube.com/embed/fcODoUgh5xo?si=lVJZogijsUzNIdTe&amp;start=14&mute=${isMuted ? 1 : 0}`}
              title="Pengurangan Bilangan Cacah"
          ...
          <p className="materi-description">
            Saatnya belajar mengurangi! Kita akan menghitung sisa uang, sisa
            pensil, atau barang yang dipakai, dengan cara sederhana yang bisa
          ...
          <div className="ringkasan-section">
            ...
            <div className="konsep-pengurangan">
              ...
              <p className="konsep-content">
                Pengurangan adalah mengurangi atau mengambil sebagian dari
                jumlah. Seperti saat kamu membeli jajan dengan uang Rp. 1.000
                dengan harga jajan nya sebesar Rp. 500, Maka kembalian yang kamu
                terima adalah sebesar Rp. 500.
              </p>
              <div className="example">
                <p className="konsep-content">
                  Contoh dalam kehidupan sehari-hari:
                  <br />
                  • Dayu punya Rp800, digunakan Rp250 → sisa uang: 800 - 250 =
                  Rp550
                  <br />• Di kelas ada 500 pensil, tersisa 380 → yang dipakai:
                  500 - 380 = 120 pensil
                </p>
              </div>
            </div>
